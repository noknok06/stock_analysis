...
class StockAnalysisAI:
    ...
    def __init__(self):
        ...
        # センチメント分析パターン
        self.positive_patterns = r'良い|上昇|成長|利益|好調|期待|強い|優秀|安定|買い|ポジティブ|有望'
        self.negative_patterns = r'悪い|下落|減少|損失|不調|心配|弱い|危険|不安定|売り|ネガティブ|懸念'
    ...
    def _extract_tags(self, text: str) -> Dict[str, Any]:
        ...
        return {
            'tags': [t['tag'] for t in detected_tags[:6]],
